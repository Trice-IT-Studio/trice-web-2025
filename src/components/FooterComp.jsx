...
const FooterComp = () => {
  return (
    <div>
      {/* <footer className="bg-blue-gray-900 pb-12 pt-24">
        <div className="container">
          <div className="flex flex-wrap">
            <div className="mb-12 w-full px-4 font-medium text-blue-gray-100 md:w-1/3">
              <h2 className="mb-5 text-4xl font-bold text-white">Alamat</h2>
            ...
            <div className="mb-12 w-full px-4 md:w-1/3">
              ...
              <ul className="text-blue-gray-100">
                <li>
                  <a
                    href="#"
            ...
            <div className="w-full border-t border-slate-700 pt-10">
              <div className="mb-5 flex items-center justify-center">
                <a
                  href="#"
                  target="_blank"
                  className="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-blue-gray-100 hover:border-primary hover:bg-teal-400 hover:text-white"
                >
                  <svg
              ...
              <p className="text-center text-xs font-medium text-blue-gray-50">
                Copyright &copy; 2023 Trice. All rights reserved
              </p>
            </div>
          </div>
        </div>
